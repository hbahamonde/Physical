...
\node[draw,fill=red,text=black,align=center] (B5) at (8.2,0) {{\bf {\scriptsize Lower}}\\{\scriptsize turnout$\star$}};
...
\node[draw,fill=black!30!green,text=black,align=center] (A5) at (8.2,2) {{\bf {\scriptsize Higher}}\\{\scriptsize turnout$\star$}};
...
\coordinate (dm1) at (6.5,2.6);
\coordinate (dm2) at (6.5,-0.7);
\node[rectangle,draw,minimum width=0.7cm] [fit = (dm1) (dm2)] (bx4) {};
\node[align=center,fill=orange,font=\scriptsize,rotate=90] at (bx4.center) {Voter uses heuristics \\in low-information election};

\node[draw,fill=pink,font=\tiny,minimum width=0.1cm,thin] at (7,-2) {$\star$Particularly for women};


\draw[-,draw=blue,thick] (A2) to (bx4);
\draw[-,draw=blue,thick] (B2) to (bx4);

\draw[->,draw=blue,thick] (bx4) to (A5);
\draw[->,draw=blue,thick] (bx4) to (B5);
